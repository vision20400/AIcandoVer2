...
public class publicData {
    ...
    public String[][][] cardItemStrList = {
            {{"상황에 따라 직감적인 판단을 할 수 있어요." , "지치고 피로를 느끼지만, 배우지 않은 지식도\n" +
                    "스스로 생각할 수 있어요." , "상대방의 기분을 읽고 말하거나 행동해요." , "기억할 필요가 없는 지식은 잊어 버리고, 중요한 것에 집중해요." , "말의 숨은 의미를 이해하면서 대화해요." , "새로운 아이디어를 생각해내요." , "위험한 순간에 즉각적으로 판단하여 자신을 보호해요." , "상대방의 마음을 이해하고 다른 사람과 협력하는데 익숙해요." , "번뜩이는 아이디어와 직감이 있어요." , "사고, 재난 상황처럼 언제 무슨 일이 일어날지\n" +
                    "예측 불가능한 상황에서 즉시 판단, 대응해요" , "뉴턴의 사과와 같이 전혀 관련 없는\n" +
                    "사실들을 통해 새로운 사실을 발견할 수 있어요."} ,
                    {"바둑을 둘 때 수많은 다음 수를 순식간에 계산해요" , "한 번 익힌 지식은 잊지 않고 계속 기억해요" , "엄청난 교통정보 속에서 목적지까지 실시간으로\n" +
                            "가장 빠르게 가는 길을 찾아요." , "정해진 기준대로 아주 정확하게 그림이나 영상을\n" + "판별하고 음성을 이해할 수 있어요" , "수많은 그림이나 사진, 음성을 구별, 분간하는 일을 잘해요." ,
                            "과거의 경험과 데이터를 학습해서 알맞은 답을 찾아내요." , "쉬지 않고 일할 수 있어요." , "순간적인 판단보다 과거의 경험,\n" +
                            "데이터 속에서 알맞은 정답을 찾아요." , "정해두지 않은 일이 일어나면 대응하는데 어려움을 겪어요." , "반복적인 작업을 아주 쉽게 처리해요." , "기계적인 작동으로 실수를 최소화 시켜요."} ,
            } ,
            {{"선생님" , "소방관" , "택시기사" , "군인" , "의사" , "전화상담원" , "요리사"} ,
                    {"축구선수" , "판사" , "화가" , "유튜버"} ,
                    {"프로게이머" , "가수"}} ,
    ...
    public int[][] boxBackgroundImg = {
            {R.drawable.box_ai_1 , R.drawable.box_ai_2 , R.drawable.box_ai_3 , R.drawable.box_ai_4 , R.drawable.box_ai_5 , R.drawable.box_ai_6 , R.drawable.box_ai_7 , R.drawable.box_ai_8 , R.drawable.box_ai_9 , R.drawable.box_ai_10 , R.drawable.box_ai_10} ,
            {R.drawable.box_people_1 , R.drawable.box_people_2 , R.drawable.box_people_3 , R.drawable.box_people_4 , R.drawable.box_people_5 , R.drawable.box_people_6 , R.drawable.box_people_7 , R.drawable.box_people_8 , R.drawable.box_people_9 , R.drawable.box_people_10 , R.drawable.box_people_10}
    };
