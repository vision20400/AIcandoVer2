...
public class Scene6_2_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //문제
        quizzes.put("모럴머신은 트롤리의 딜레마를 인공지능이 운전하는 자율 주행 자동차에 적용시켜 만든 것이다. ","o");
        quizzes.put("모럴머신 활동 결과, 전세계 사람들은 모두 같은 선택을 했다. ","x");
        quizzes.put("사람들 사이에서도 생각이 다르기 때문에 인공지능의 윤리 알고리즘을 만드는 일은 매우 어렵다. ","o");
        quizzes.put("트롤리의 딜레마는 많은 사람을 살리기 위해 한 명을 희생해도 괜찮은지를 물어보는 도덕적 실험이다. ","o");
