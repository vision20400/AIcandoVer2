...
public class Scene4_2_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //문제
        quizzes.put("인공지능에 대한 연구는 2000년부터 시작되었다. ","x");
        quizzes.put("1956년 다트머스 회의에서 처음으로 인공지능이라는 말이 사용되었다. ","o");
        quizzes.put("인공지능 연구는 여러 번의 암흑기를 극복하며 발전해왔다. ","o");
        quizzes.put("오늘날 인공지능은 미로나 퍼즐 같은 단순한 문제만 해결할 수 있었다. ","x");
