...
public class Scene4_3_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //문제
        quizzes.put("튜링테스트는 무엇이 인공지능이고 인공지능이 아닌지 판별하는 테스트이다. ","o");
        quizzes.put("지금까지 튜링테스트를 통과한 인공지능은 없다. ","x");
        quizzes.put("유진 구스트만은 우크라이나 소년으로 설정된 인공지능으로 영어를 잘하지 못하고 엉뚱한 대답을 했다. ","o");
        quizzes.put("튜링테스트는 존 매카시가 만들었다. ","x");
