...
public class Scene6_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene4_0_1("mjzj-DKVOeI")).commit();


        //top메뉴
        topMenu = new topMenu( 61 );
        ...
        radio4_1Group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.radio4_1_1){
                    ...
                    getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene6_1_2()).commit();
                    changeButton(scene4_1_pbtn,scene4_1_nbtn,2,group);
                }
                else if(checkedId == R.id.radio4_1_3){
                    getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene4_0_3(61)).commit();
