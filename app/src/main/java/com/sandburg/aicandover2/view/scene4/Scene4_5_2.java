...
public class Scene4_5_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //문제
        quizzes.put("아이언맨의 자비스는 약한 인공지능이다. ","x");
        quizzes.put("현재 만들어진 인공지능은 모두 약한 인공지능이다. ","o");
        quizzes.put("알파고는 바둑뿐만 아니라 장기, 체스도 잘 둔다. ","x");
        quizzes.put("약한 인공지능은 여러 가지 감정을 느끼거나 다른 사람의 마음을 이해할 수 있다. ","x");
        quizzes.put("강한 인공지능은 사람과 같은 지능을 가지고 있다. ","o");
