...
public class Scene4_1_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //문제
        quizzes.put("인공지능이란 사람처럼 생각하고 판단해서 행동할 수 있도록 만들어낸 컴퓨터 프로그램이다. ","o");
        quizzes.put("인공지능의 인공이란 산, 나무, 꽃, 구름과 같은 것을 말한다. ","x");
        quizzes.put("우리 생활 속 인공지능의 활용 사례로는 인공지능 스피커, 유튜브의 추천 영상 시스템 등이 있다. ","o");
        quizzes.put("인공지능은 영어로 Android I-Phone, AI라고 한다. ","x");
