...
public class Scene4_5 extends AppCompatActivity { //#씬4_1 AI란
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene4_0_1("ZipHSjRQM1g")).commit();


        //top메뉴
        topMenu = new topMenu( 45 );
        ...
        radio4_1Group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId == R.id.radio4_1_1){
                    ...
                    getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene4_5_2()).commit();
                    changeButton(scene4_1_pbtn,scene4_1_nbtn,2,group);
                }
                else if(checkedId == R.id.radio4_1_3){
                    getSupportFragmentManager().beginTransaction().replace(R.id.scene4_frame, new Scene4_0_3(45)).commit();
